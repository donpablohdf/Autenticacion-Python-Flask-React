...
export const Navbar = () => {
	...
	return (
		<nav className="navbar bg-secondary text-bg-secondary p-3 d-flex sticky-top">
			...
			<div className="pl-5 "><Link to="api/private" ><button className="btn btn-secondary" type="button">Private Area</button></Link></div>

			<div className="dropdown d-flex flex-row-reverse ">
				<Link to="api/login" ><button className="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">Login</button>
					{/* <Login /> */}
				</Link>
			</div>

			<div className="pl-5 "><Link to="api/signup" >
				<button className="btn btn-secondary" type="button">Signup</button></Link>
			</div>

			<div className="dropdown d-flex flex-row-reverse ancho-drop">
