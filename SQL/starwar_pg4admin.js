...
--Started on 2022 - 11 - 21 13: 17: 49 CET
...
--
--TOC entry 3578(class 1262 OID 16397)
--Name: starwars; Type: DATABASE; Schema: -; Owner: forgeeks
--

    CREATE DATABASE starwars WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'es_ES.UTF-8';


ALTER DATABASE starwars OWNER TO forgeeks;
...
--Name: favorites; Type: TABLE; Schema: public; Owner: forgeeks
--
...
ALTER TABLE public.favorites OWNER TO forgeeks;
...
--
--TOC entry 241(class 1259 OID 17255)
--Name: favoritos_id_seq; Type: SEQUENCE; Schema: public; Owner: forgeeks
--
...
--
--TOC entry 234(class 1259 OID 17183)
...
--
--TOC entry 235(class 1259 OID 17186)
...
--
--TOC entry 237(class 1259 OID 17192)
...
--
--TOC entry 228(class 1259 OID 17055)
...
--
--TOC entry 233(class 1259 OID 17180)
...
--
--TOC entry 238(class 1259 OID 17195)
...
--
--TOC entry 232(class 1259 OID 17121)
...
--
--TOC entry 3571(class 0 OID 17243)
--Dependencies: 240
--Data for Name: favorites; Type: TABLE DATA; Schema: public; Owner: forgeeks
--

    COPY public.favorites(id, favs, user_public_id) FROM stdin;
3	{ "favs": [{ "clase": "films", "encuentra": "films2", "id": 2, "title": "The Empire Strikes Back" }, { "clase": "films", "encuentra": "films3", "id": 3, "title": "Return of the Jedi" }, { "clase": "films", "encuentra": "films4", "id": 4, "title": "The Phantom Menace" }] } 2573e26e - 94f1 - 42fa - add6 - 181aa5798fb2
\.


--
--TOC entry 3555(class 0 OID 16974)
--Dependencies: 224
...
--
--TOC entry 3556(class 0 OID 16995)
--Dependencies: 225
...
--
--TOC entry 3557(class 0 OID 17022)
--Dependencies: 226
...
--
--TOC entry 3558(class 0 OID 17040)
--Dependencies: 227
...
--
--TOC entry 3559(class 0 OID 17055)
--Dependencies: 228
...
--
--TOC entry 3560(class 0 OID 17084)
--Dependencies: 229
...
--
--TOC entry 3562(class 0 OID 17108)
--Dependencies: 231
...
5	\N	leticia	SHA256$c836qqJn0uocify1$d1c912f33509ca9c60098262ef58eed5357b2487f755aa85b4f41e77130d9ae1	\N	\N	\N	\N	\N	c8138ca2 - c9bf - 42b4 - a3d4 - f17f22fe1667
6	\N	hola	SHA256$1cQOzgYzep0GG9Kj$10a8610e8587f147d284d35ad03568fe3f0b0c1d1ea6ca934a28e98195aa3bc6	\N	\N	\N	\N	\N	3d65d4e2 - 4aaa - 44fd - 96ff - 7b5d6f570688
250	\N	manolito	SHA256$DLylHIM672s3TE5c$6c47ed027d09cf899f7a0fbdf36097ff7efbf5db3b23f24f4e16e6a7021b2343	\N	\N	\N	\N	\N	2573e26e - 94f1 - 42fa - add6 - 181aa5798fb2
\.


--
--TOC entry 3563(class 0 OID 17121)
--Dependencies: 232
--Data for Name: vehicles; Type: TABLE DATA; Schema: public; Owner: forgeeks
--

    COPY public.vehicles(id, description, model, vehicle_class, manufacturer, cost_in_credits, length, crew, passengers, max_atmosphering_speed, cargo_capacity, consumables, name, films, pilots, url) FROM stdin;
...
--Dependencies: 241
--Name: favoritos_id_seq; Type: SEQUENCE SET; Schema: public; Owner: forgeeks
--

    SELECT pg_catalog.setval('public.favoritos_id_seq', 3, true);
...
--
    ...
    SELECT pg_catalog.setval('public.users_id_seq1', 261, true);
...
--
--TOC entry 3399(class 2606 OID 17249)
--Name: favorites favoritos_pk; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--

    ALTER TABLE ONLY public.favorites
    ADD CONSTRAINT favoritos_pk PRIMARY KEY(id);


--
--TOC entry 3381(class 2606 OID 17182)
...
--
--TOC entry 3383(class 2606 OID 17185)
...
--
--TOC entry 3385(class 2606 OID 17188)
...
--
--TOC entry 3387(class 2606 OID 17191)
...
--
--TOC entry 3389(class 2606 OID 17179)
...
--
--TOC entry 3391(class 2606 OID 17194)
...
--
--TOC entry 3393(class 2606 OID 17215)
--Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--

    ALTER TABLE ONLY public.users
    ADD CONSTRAINT users_pkey PRIMARY KEY(id) INCLUDE(public_id);


--
--TOC entry 3395(class 2606 OID 17242)
--Name: users users_un; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--

    ALTER TABLE ONLY public.users
    ADD CONSTRAINT users_un UNIQUE(public_id);


--
--TOC entry 3397(class 2606 OID 17198)
--Name: vehicles vechicles_detail_pkey; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--
...
--
--TOC entry 3400(class 2606 OID 17250)
--Name: favorites favoritos_fk; Type: FK CONSTRAINT; Schema: public; Owner: forgeeks
--

    ALTER TABLE ONLY public.favorites
    ADD CONSTRAINT favoritos_fk FOREIGN KEY(user_public_id) REFERENCES public.users(public_id);


--Completed on 2022 - 11 - 21 13: 17: 50 CET
