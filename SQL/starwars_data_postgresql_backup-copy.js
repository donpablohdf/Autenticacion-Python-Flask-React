...
--
-- Name: films_detail; Type: TABLE; Schema: public; Owner: forgeeks
--

CREATE TABLE public.films_detail (
    id integer NOT NULL,
    description character varying(255) DEFAULT NULL::character varying,
    producer character varying(255) DEFAULT NULL::character varying,
    title character varying(255) DEFAULT NULL::character varying,
...
ALTER TABLE public.films_detail OWNER TO forgeeks;
...
--
-- Name: people_detail; Type: TABLE; Schema: public; Owner: forgeeks
--

CREATE TABLE public.people_detail (
    id integer NOT NULL,
    description character varying(255) DEFAULT NULL::character varying,
...
ALTER TABLE public.people_detail OWNER TO forgeeks;
...
--
-- Name: planets_detail; Type: TABLE; Schema: public; Owner: forgeeks
--

CREATE TABLE public.planets_detail (
    id integer NOT NULL,
    description character varying(255) DEFAULT NULL::character varying,
...
ALTER TABLE public.planets_detail OWNER TO forgeeks;
...
--
-- Name: species_detail; Type: TABLE; Schema: public; Owner: forgeeks
--
...
ALTER TABLE public.species_detail OWNER TO forgeeks;
...
--
-- Name: starships_detail; Type: TABLE; Schema: public; Owner: forgeeks
--

CREATE TABLE public.starships_detail (
    id integer NOT NULL,
    description character varying(255) DEFAULT NULL::character varying,
...
ALTER TABLE public.starships_detail OWNER TO forgeeks;
...
CREATE TABLE public.users (
    id integer NOT NULL,
    name character varying(255) DEFAULT NULL::character varying,
    user_login character varying(255) DEFAULT NULL::character varying,
...
--
-- Name: vechicles_detail; Type: TABLE; Schema: public; Owner: forgeeks
--

CREATE TABLE public.vechicles_detail (
    id integer NOT NULL,
    description character varying(255) DEFAULT NULL::character varying,
    model character varying(255) DEFAULT NULL::character varying,
...
ALTER TABLE public.vechicles_detail OWNER TO forgeeks;
...
--
-- Name: vehicles; Type: TABLE; Schema: public; Owner: forgeeks
--
...
ALTER TABLE public.vehicles OWNER TO forgeeks;
...
COPY public.people (id, name, url) FROM stdin;
1	Luke Skywalker	1
2	C-3PO	2
3	R2-D2	3
4	Darth Vader	4
5	Leia Organa	5
6	Owen Lars	6
7	Beru Whitesun lars	7
8	R5-D4	8
9	Biggs Darklighter	9
10	Obi-Wan Kenobi	10
11	Anakin Skywalker	11
12	Wilhuff Tarkin	12
13	Chewbacca	13
14	Han Solo	14
15	Greedo	15
16	Jabba Desilijic Tiure	16
18	Wedge Antilles	18
19	Jek Tono Porkins	19
20	Yoda	20
21	Palpatine	21
22	Boba Fett	22
23	IG-88	23
24	Bossk	24
25	Lando Calrissian	25
26	Lobot	26
27	Ackbar	27
28	Mon Mothma	28
29	Arvel Crynyd	29
30	Wicket Systri Warrick	30
31	Nien Nunb	31
32	Qui-Gon Jinn	32
33	Nute Gunray	33
34	Finis Valorum	34
...
61	Cordé	61
62	Cliegg Lars	62
63	Poggle the Lesser	63
64	Luminara Unduli	64
65	Barriss Offee	65
66	Dormé	66
67	Dooku	67
68	Bail Prestor Organa	68
69	Jango Fett	69
70	Zam Wesell	70
71	Dexter Jettster	71
72	Lama Su	72
73	Taun We	73
74	Jocasta Nu	74
75	R4-P17	75
...
--
-- Data for Name: people_detail; Type: TABLE DATA; Schema: public; Owner: forgeeks
--

COPY public.people_detail (id, description, height, mass, hair_color, skin_color, eye_color, birth_year, gender, name, homeworld, url) FROM stdin;
...
COPY public.planets (id, name, url) FROM stdin;
1	Tatooine	1
2	Alderaan	2
3	Yavin IV	3
4	Hoth	4
...
--
-- Data for Name: planets_detail; Type: TABLE DATA; Schema: public; Owner: forgeeks
--

COPY public.planets_detail (id, description, diameter, rotation_period, orbital_period, gravity, population, climate, terrain, surface_water, name, url) FROM stdin;
...
--
-- Data for Name: species_detail; Type: TABLE DATA; Schema: public; Owner: forgeeks
--

COPY public.species_detail (id, description, classification, designation, average_height, average_lifespan, hair_colors, skin_colors, eye_colors, language, name, homeworld, people, url) FROM stdin;
...
COPY public.starships (id, name, url) FROM stdin;
2	CR90 corvette	2
3	Star Destroyer	3
5	Sentinel-class landing craft	5
9	Death Star	9
10	Millennium Falcon	10
11	Y-wing	11
12	X-wing	12
13	TIE Advanced x1	13
15	Executor	15
17	Rebel transport	17
21	Slave 1	21
22	Imperial shuttle	22
23	EF76 Nebulon-B escort frigate	23
27	Calamari Cruiser	27
28	A-wing	28
29	B-wing	29
31	Republic Cruiser	31
32	Droid control ship	32
39	Naboo fighter	39
40	Naboo Royal Starship	40
41	Scimitar	41
43	J-type diplomatic barge	43
47	AA-9 Coruscant freighter	47
48	Jedi starfighter	48
49	H-type Nubian yacht	49
52	Republic Assault ship	52
58	Solar Sailer	58
59	Trade Federation cruiser	59
61	Theta-class T-2c shuttle	61
63	Republic attack cruiser	63
64	Naboo star skiff	64
65	Jedi Interceptor	65
66	arc-170	66
68	Banking clan frigte	68
74	Belbullab-22 starfighter	74
75	V-wing	75
\.


--
-- Data for Name: starships_detail; Type: TABLE DATA; Schema: public; Owner: forgeeks
--

COPY public.starships_detail (id, description, model, starship_class, manufacturer, cost_in_credits, length, crew, passengers, max_atmosphering_speed, hyperdrive_rating, mglt, cargo_capacity, consumables, pilots, name, url) FROM stdin;
...
COPY public.users (id, name, user_login, password, firstname, lastname, email, is_active) FROM stdin;
\.


--
-- Data for Name: vechicles_detail; Type: TABLE DATA; Schema: public; Owner: forgeeks
--

COPY public.vechicles_detail (id, description, model, vehicle_class, manufacturer, cost_in_credits, length, crew, passengers, max_atmosphering_speed, cargo_capacity, consumables, name, films, pilots, url) FROM stdin;
...
--
-- Data for Name: vehicles; Type: TABLE DATA; Schema: public; Owner: forgeeks
--

COPY public.vehicles (id, name, url) FROM stdin;
4	Sand Crawler	4
6	T-16 skyhopper	6
7	X-34 landspeeder	7
8	TIE/LN starfighter	8
14	Snowspeeder	14
16	TIE bomber	16
18	AT-AT	18
19	AT-ST	19
20	Storm IV Twin-Pod cloud car	20
24	Sail barge	24
25	Bantha-II cargo skiff	25
26	TIE/IN interceptor	26
30	Imperial Speeder Bike	30
33	Vulture Droid	33
34	Multi-Troop Transport	34
35	Armored Assault Tank	35
36	Single Trooper Aerial Platform	36
37	C-9979 landing craft	37
38	Tribubble bongo	38
42	Sith speeder	42
44	Zephyr-G swoop bike	44
45	Koro-2 Exodrive airspeeder	45
46	XJ-6 airspeeder	46
50	LAAT/i	50
51	LAAT/c	51
53	AT-TE	53
54	SPHA	54
55	Flitknot speeder	55
56	Neimoidian shuttle	56
57	Geonosian starfighter	57
60	Tsmeu-6 personal wheel bike	60
62	Emergency Firespeeder	62
67	Droid tri-fighter	67
69	Oevvaor jet catamaran	69
70	Raddaugh Gnasp fluttercraft	70
71	Clone turbo tank	71
72	Corporate Alliance tank droid	72
73	Droid gunship	73
76	AT-RT	76
\.
...
--
-- Name: films_detail films_detail_pkey; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--

ALTER TABLE ONLY public.films_detail
    ADD CONSTRAINT films_detail_pkey PRIMARY KEY (id);


--
-- Name: films films_pkey; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--
...
--
-- Name: people_detail people_detail_pkey; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--

ALTER TABLE ONLY public.people_detail
    ADD CONSTRAINT people_detail_pkey PRIMARY KEY (id);


--
-- Name: people people_pkey; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--
...
--
-- Name: planets_detail planets_detail_pkey; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--

ALTER TABLE ONLY public.planets_detail
    ADD CONSTRAINT planets_detail_pkey PRIMARY KEY (id);


--
-- Name: planets planets_pkey; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--
...
--
-- Name: species_detail species_detail_pkey; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--

ALTER TABLE ONLY public.species_detail
    ADD CONSTRAINT species_detail_pkey PRIMARY KEY (id);


--
-- Name: species species_pkey; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--
...
--
-- Name: starships_detail starships_detail_pkey; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--

ALTER TABLE ONLY public.starships_detail
    ADD CONSTRAINT starships_detail_pkey PRIMARY KEY (id);


--
-- Name: starships starships_pkey; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--
...
--
-- Name: vechicles_detail vechicles_detail_pkey; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--

ALTER TABLE ONLY public.vechicles_detail
    ADD CONSTRAINT vechicles_detail_pkey PRIMARY KEY (id);


--
-- Name: vehicles vehicles_pkey; Type: CONSTRAINT; Schema: public; Owner: forgeeks
--
